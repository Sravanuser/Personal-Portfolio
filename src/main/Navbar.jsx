...
export default function Navbar(props){
    ...
    return(
        ...
        <motion.li initial={animatefrom} transition={{delay:0.50}} animate={animateto}  onClick={()=>props.isMobile && props.CloseMobileMenu()}><NavLink style={({isActive})=>
        isActive ? activeLink : normalLink} to='/resume'>Resume</NavLink></motion.li>
        </div>
    )
}